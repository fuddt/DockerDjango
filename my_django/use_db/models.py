...
class PokemonInfo(models.Model):
    ...
    def __str__(self):
        return '<p>trainers_id: ' + str(self.id) + ',' +\
                '</p><p>trainers_name: ' + str(self.trainers_name) + ',' +\
                '</p><p>pokemons_name: ' + str(self.pokemons_name) + ',' +\
                '</p><p>pokemons_level:' + str(self.pokemons_level) + ',' +\
                '</p><p>self_introduction:' + str(self.self_intro)